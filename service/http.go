...
// ShouldCopyUpstreamHeader reports whether an upstream response header should
// be copied to the client. Content-Length is managed locally, and the upstream
// request ID is captured without overriding this instance's request ID.
