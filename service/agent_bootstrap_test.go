...
func setupAgentBootstrapTestDB(t *testing.T) *gorm.DB {
	...
	prevAgentEnabled := common.AgentEnabled
	prevAgentInitialized := common.AgentInitialized
	prevAgentDefaultRebateRate := common.AgentDefaultRebateRate
	prevDB := model.DB
	...
	require.NoError(t, db.AutoMigrate(
		...
		&model.AgentWithdrawAccount{},
		&model.AgentWithdrawRequest{},
		&model.AgentBalanceLedger{},
	))
	model.InitOptionMap()
	...
	t.Cleanup(func() {
		...
		common.AgentEnabled = prevAgentEnabled
		common.AgentInitialized = prevAgentInitialized
		common.AgentDefaultRebateRate = prevAgentDefaultRebateRate
