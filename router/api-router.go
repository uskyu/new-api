...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		{
			quickLoginRoute.POST("/start", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.StartQuickLogin)
			quickLoginRoute.POST("/exchange", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.ExchangeQuickLogin)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/redemption/self", controller.GetUserRedemptionBills)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/redemption", controller.GetAllRedemptionBills)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.GET("/:id/topups", controller.GetUserTopUpsByAdmin)
				adminRoute.GET("/:id/redemptions", controller.GetUserRedemptionBillsByAdmin)
