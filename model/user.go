...
type User struct {
	...
	PromoLinkId       int            `json:"promo_link_id" gorm:"type:int;column:promo_link_id;index"`
	...
	LastAPIActivityAt int64          `json:"last_api_activity_at" gorm:"type:bigint;default:0;column:last_api_activity_at;index"`
}
