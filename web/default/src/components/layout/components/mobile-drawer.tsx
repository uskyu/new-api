...
import { X, User, Wallet, LogOut, Wrench } from 'lucide-react'
import { AnimatePresence, motion, type Variants } from 'motion/react'
import { useTranslation } from 'react-i18next'
import type { AuthUser } from '@/stores/auth-store'
import useDialogState from '@/hooks/use-dialog'
import { useSidebarUrlVisible } from '@/hooks/use-sidebar-config'
...
function MobileUserProfile({ user, onNavigate }: MobileUserProfileProps) {
  ...
  const showSelfService = useSidebarUrlVisible('/self-service')
